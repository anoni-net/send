...
| `:5.1.0` | that [release](https://github.com/anoni-net/send/releases). Stable, since we do not retag |
...
```dockerfile
FROM ghcr.io/anoni-net/send:5.1.0
USER root
...
`ghcr.io/anoni-net/send:5.1.0` if you want the build this repository publishes.
